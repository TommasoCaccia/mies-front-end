    ...
    return (
        <>
            <div className={`container ${classes.container}`}>
                <img src="/CertificatiBianchi.jpg" className={`${classes.imgDiagnosi} d-block`} alt="Logo"/>
                <div className={classes.textContainer}>
                    <h1 className={classes.titoloServizi}>
                        I Certificati Bianchi<br></br>
                    ...
                    <p className={classes.paragrafoServizi}>
                        ...
                        in denaro per
                        l’intervento effettuato.<br></br><br></br>
